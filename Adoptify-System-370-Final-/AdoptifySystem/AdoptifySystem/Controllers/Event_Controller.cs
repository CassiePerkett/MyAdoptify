...
namespace AdoptifySystem.Controllers
{
    public class Event_Controller : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Event_ID,Event_Name,Event_StartTime,Event_EndTime,Event_Guest_Number,Event_Ticket_Price,Event_Location,Event_Description,Event_Type_ID")] Event_ event_)
        {
